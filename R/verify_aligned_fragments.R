...
#'
#' Verifies that aligned fragments are contained within the ground-truth fragments generated by <code>make_fragments()</code>. Aligned fragments that are not contained within the generated fragments are discarded, as they were spuriously aligned. Properly aligned fragments are returned.
#'
