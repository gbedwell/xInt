...
#'@param offset The nucleotide position of interest relative to the first nucleotide of the target site duplication. Defaults to 0, i.e. the first nucleotide of the duplication. Only used when width of given sites is not 1.
